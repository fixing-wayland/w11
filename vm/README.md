...
| `resolute-hypr` | Ubuntu 26.04 LTS | Hyprland 0.53.3 (aquamarine 0.9.x), Xwayland, `foot`, `wl-mirror` | greetd (`[initial_session]`, `command = "Hyprland"`) | Wayland | `hyprctl -j monitors`; `wlr-randr` 0.4.1 as a second READER only | `ubuntu` | push |
